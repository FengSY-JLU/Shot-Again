...
parser.add_argument('--data_train', type=str, default='../Dataset/UIEBD/train')
parser.add_argument('--label_train', type=str, default='../Dataset/UIEBD/train')
parser.add_argument('--data_augmentation', type=bool, default=True)
parser.add_argument('--data_test', type=str, default='../Dataset/UIEBD/test')
parser.add_argument('--label_test', type=str, default='../Dataset/UIEBD/test')
...
parser.add_argument('--Margin', type=float, default=0.5, metavar='M', help='margin for triplet loss (default: 0.5)')
...
parser.add_argument('--model', default='final_weight/RUIE_final.pth', help='Pretrained base model')
...
def train(flag):
    ...
    for iteration, batch in enumerate(training_data_loader, 1):
        ...
        loss_J = mse_loss(j_out_mix, j_out.detach())
        ...
        loss_4 = loss_triplet + 0.001 * loss_embedd

        loss_C = color_loss(j_out)

        total_loss = 1 * loss_1 + 1 * loss_J + 0.01 * loss_C + 0.01 * loss_4
